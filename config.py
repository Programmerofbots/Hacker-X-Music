...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/bindplant123/Hacker-X-Music",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/OP_SUPPORTS")
...
# Path to a Netscape-format cookies.txt for yt-dlp. Strongly recommended on
# a VPS to avoid YouTube's bot-detection blocking datacenter IPs.
# Folder containing cookies*.txt files for yt-dlp (rotation pool). Strongly
# recommended on a VPS to avoid YouTube's bot-detection blocking datacenter IPs.
COOKIES_DIR = getenv("COOKIES_DIR", ".")
